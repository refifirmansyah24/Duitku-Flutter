...
class $TransactionsTable extends Transactions
  ...
  late final GeneratedColumn<DateTime> transaction_date =
      GeneratedColumn<DateTime>('transaction_date', aliasedName, false,
          type: DriftSqlType.dateTime, requiredDuringInsert: true);
  static const VerificationMeta _amuntMeta = const VerificationMeta('amunt');
  @override
  late final GeneratedColumn<int> amunt = GeneratedColumn<int>(
      'amunt', aliasedName, false,
      type: DriftSqlType.int, requiredDuringInsert: true);
  static const VerificationMeta _createdAtMeta =
      const VerificationMeta('createdAt');
  @override
  ...
  VerificationContext validateIntegrity(Insertable<Transaction> instance,
    ...
    if (data.containsKey('amunt')) {
      context.handle(
          _amuntMeta, amunt.isAcceptableOrUnknown(data['amunt']!, _amuntMeta));
    } else if (isInserting) {
      context.missing(_amuntMeta);
    }
    if (data.containsKey('created_at')) {
      context.handle(_createdAtMeta,
          createdAt.isAcceptableOrUnknown(data['created_at']!, _createdAtMeta));
  ...
  Transaction map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Transaction(
      ...
      amunt: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}amunt'])!,
      createdAt: attachedDatabase.typeMapping
          .read(DriftSqlType.dateTime, data['${effectivePrefix}created_at'])!,
      updatedAt: attachedDatabase.typeMapping
          .read(DriftSqlType.dateTime, data['${effectivePrefix}updated_at'])!,
...
class Transaction extends DataClass implements Insertable<Transaction> {
  ...
  factory Transaction.fromJson(Map<String, dynamic> json,
    ...
    return Transaction(
      ...
      amunt: serializer.fromJson<int>(json['amunt']),
      createdAt: serializer.fromJson<DateTime>(json['createdAt']),
      updatedAt: serializer.fromJson<DateTime>(json['updatedAt']),
      deletedAt: serializer.fromJson<DateTime?>(json['deletedAt']),
    );
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'amunt': serializer.toJson<int>(amunt),
      'createdAt': serializer.toJson<DateTime>(createdAt),
      'updatedAt': serializer.toJson<DateTime>(updatedAt),
      'deletedAt': serializer.toJson<DateTime?>(deletedAt),
    };
  ...
  int get hashCode => Object.hash(id, name, category_id, transaction_date,
      amunt, createdAt, updatedAt, deletedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class TransactionsCompanion extends UpdateCompanion<Transaction> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (amunt.present) {
      map['amunt'] = Variable<int>(amunt.value);
    }
    if (createdAt.present) {
      map['created_at'] = Variable<DateTime>(createdAt.value);
    }
